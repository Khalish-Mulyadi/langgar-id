<?php 
	...
	$itungpengajar = mysqli_query($conn,"select count(id) as jumlahpengajar from guru_ngaji");
	$itungpengajar2 = mysqli_fetch_assoc($itungpengajar);
	$itungpengajar3 = $itungpengajar2['jumlahpengajar'];
