                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active"><a href="pengajar.php"><span>Kelola Pengajar</span></a></li>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$pengajar=mysqli_query($conn,"SELECT * from guru_ngaji order by id ASC");
											$no=1;
											while($p=mysqli_fetch_array($pengajar)){
												...
												<tr>
													<td><?php echo $no++ ?></td>
                                                    <td><img src="../assets/images/profilepic/<?php echo $p['gambar']; ?>" style="width: 100px; height: 100px; object-fit: cover;" alt=""/></td>
