                        ...
                        <div class="navbar-nav">
							...
							<div class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarDarkDropdownMenuLink">
        						    <li><a class="dropdown-item" href="user-profile/myprofile.php?uid=<?php echo $_SESSION['id_user'] ?>">Lihat Profile</a></li>
							...
							<img src="assets/images/profilepic/<?php echo $p['gambar'] ?>" class="card-img-top card_picture">
								<div class="card-body">
									...
									<div class="text-center">
										<a href="user-profile/profilepage.php?uid=<?php echo $p['uid'] ?>" class="btn">Lihat Profile</a>
									</div>
								</div>
						</div>
					</div>
